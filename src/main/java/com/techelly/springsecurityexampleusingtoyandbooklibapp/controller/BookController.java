...
public class BookController {
	...
	@PreAuthorize("hasRole('USER') or hasRole('PARENT') or hasRole('ADMIN') or hasRole('CHILD')")
	public ResponseEntity<Book> viewBookByTitle(@PathVariable("title") String title,SecurityContext cxt) throws BookNotFoundException{
		System.out.println(cxt.getAuthentication().getPrincipal());
